...
$new_endereco=mysqli_real_escape_string($con,$_POST['endereco']);
$new_bairro=mysqli_real_escape_string($con,$_POST['bairro']);
$new_cidade=mysqli_real_escape_string($con,$_POST['cidade']);
$new_estado=mysqli_real_escape_string($con,$_POST['estado']);
$new_cep=mysqli_real_escape_string($con,$_POST['cep']);
$new_pais=mysqli_real_escape_string($con,$_POST['pais']);
...
if ( $new_endereco=="" ){
$msg=$msg."Faltou seu Endereço com o Nº.<BR>";
$status= "NOTOK";}
if ( $new_bairro=="" ){
$msg=$msg."Faltou o Nome do seu Bairro.<BR>";
$status= "NOTOK";}
if ( $new_cidade=="" ){
$msg=$msg."Faltou o Nome da sua Cidade.<BR>";
$status= "NOTOK";}
if ( $new_estado=="" ){
$msg=$msg."Faltou o Nome da sua Cidade.<BR>";
$status= "NOTOK";}
...
if ( $new_cep=="" ){
$msg=$msg."Faltou o Nº do seu Cep.<BR>";
$status= "NOTOK";}
if ( $new_pais=="" ){
$msg=$msg."Faltou o Seu pais atual.<BR>";
$status= "NOTOK";}
}
if ($status=="OK") 
{

$query=mysqli_query($con,"update affiliateuser set endereco='$new_endereco',bairro='$new_bairro',cidade='$new_cidade',estado='$new_estado',cep='$new_cep',estado='$new_pais' where username='".$_SESSION['username']."'");
                        ...
                        <div class="card">
                            ...
                            <div class="card-body"> <small class="text-muted">Seu E-mail </small>
                                ...
                                <h6><?php echo $my_endereco;?></h6>
                                 <small class="text-muted pt-4 db">Sua Localização</small>
                                <br/>
