...
$new_rg=mysqli_real_escape_string($con,$_POST['rg']);
$new_nascimento=mysqli_real_escape_string($con,$_POST['nascimento']);
$new_whats=mysqli_real_escape_string($con,$_POST['mobile']);
...
if ( $new_rg=="" ){
$msg=$msg."Faltou Digitar seu RG.<BR>";
$status= "NOTOK";}
if ( $new_nascimento=="" ){
$msg=$msg."Faltou sua Data de Nascimento.<BR>";
$status= "NOTOK";}

if ( $new_whats=="" ){
$msg=$msg."Faltou o número do seu Telefone.<BR>";
$status= "NOTOK";}
}
if ($status=="OK") 
{

$query=mysqli_query($con,"update affiliateuser set rg='$new_rg',nascimento='$new_nascimento',mobile='$new_whats' where username='".$_SESSION['username']."'");


$errormsg= "
<div class='alert alert-success'>
                    <button type='button' class='close' data-dismiss='alert'>&times;</button>
                    <i class='fa fa-ban-circle'></i><strong>Parabéns seus dados foram alterados com Sucesso! </br></strong>Dados Pessoais Atualizados com Sucesso.
					</br>
		<a href='perfil.php' class='btn btn-info'>VOLTAR  PARA O MEU PERFIL</a></div>"; //printing error if found in validation
...
<div class='alert alert-danger'>
		...
		<a href='perfil.php' class='btn btn-danger'>VOLTAR E ALTERAR OS DADOS CORRETAMENTE</a></div>"; //printing error if found in validation
                        ...
                        <div class="card">
                            ...
                            <div class="card-body"> <small class="text-muted">Seu E-mail </small>
                                ...
                                <h6><?php echo $my_endereco;?></h6>
                                 <small class="text-muted pt-4 db">Dados Pessoais</small>
                                <br/>
