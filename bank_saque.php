...
$msg=$msg." Que pena, Você não tem saldo suficiente para solicitar saque.<BR>";
$status= "NOTOK";}
...
if ($status=="OK"){
	...
	Em no máximo 7 dias úteis, enviaremos o valor de R$ <?php print number_format($valor_do_saque, 2, ',', '.'); ?> (já descontado a taxa de saque) sua conta cadastrada aqui, se ainda não cadastrou nenhum dado para recebimento, cadastre.
		...
		<a href="perfil.php" class="btn btn-info">ATUALIZAR FORMAS DE GANHOS</a></div>
		<?php
	...
	<a href='saque.php' class='btn btn-info'>VOLTAR</a></div>";
}
?>
            <!-- ============================================================== -->
            <!-- Container fluid  -->
