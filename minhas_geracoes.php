...
<head>
    ...
    <title><?php echo $my_username;?> |Minhas Gerações</title>
    <!-- chartist CSS -->
...
?>
        ...
        <div class="page-wrapper">
            ...
            <!-- Temp - Earnings -->
            <!-- ============================================================== -->
            <div class="card bg-primary mt-0 mb-0">
                <div class="card-body">
                    <h4 class="card-title text-white">Bem Vindo <?php echo $my_nome;?></h4>
                    <h5 class="card-subtitle text-white op-5">Minhas Gerações</h5>
                    <div >
                        <!-- col -->
...
?>
                                ...
                                <div class="table-responsive">
                                    <div class="col-12">
                        <h4 class="d-inline">Conheça sua Rede</h4>
                        <p class="text-muted mt-0">Indicados Indiretos</p>
                        <!-- Row -->
                        <div class="row">
                            <!-- column -->
							<div class="col-lg-3 col-md-6">
								<h4 class='card-title'>2º Geração</h4>
							<?php
// busca usuario 
if($numrows1 > 0){
	$query1="SELECT * FROM uplines where up2 ='$my_username'ORDER BY id DESC";
	
	$result1 = mysqli_query($con,$query1);
	while($row1 = mysqli_fetch_array($result1)){
		
		$dw1_user="$row1[user_id]";
		$dw1_id="$row1[id]";
                                ...
                                <div class='bg-light p-1'>
                                    <div class='toast' role='alert' data-autohide='false' aria-live='assertive' aria-atomic='true'>
                                      <div class='toast-header'>
                                        ...
                                        <strong class='mr-auto'>2º Nivel</strong>
                                        <small class='text-muted'>$dw1_id</small>
                                        <button type='button' class='ml-2 mb-1 close' data-dismiss='toast' aria-label='Close'>
                                          <span aria-hidden='true'>&times;</span>
                                        </button>
                                      </div>
                                      <div class='toast-body'>
                                        <span class='label label-info'>$dw1_user</span>
                                      </div>
                                    </div>
...
?>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <!-- Card -->
                               <h4 class='card-title'>3º Geração</h4>
							<?php
// busca usuario 
if($numrows3 > 0){
	$query3="SELECT * FROM uplines where up3 ='$my_username'ORDER BY id DESC";
	
	$result3 = mysqli_query($con,$query3);
	while($row3 = mysqli_fetch_array($result3)){
		
		$dw3_user="$row3[user_id]";
		$dw3_id="$row3[id]";
			...
			print "
					...
					<div class='card-body'>
                                ...
                                <div class='bg-light p-1'>
                                    <div class='toast' role='alert' data-autohide='false' aria-live='assertive' aria-atomic='true'>
                                      <div class='toast-header'>
                                        <svg class='bd-placeholder-img rounded mr-2' width='20' height='20' xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMidYMid slice' focusable='false' role='img'><rect fill='#36bea6' width='100%' height='100%'></rect></svg>
                                        <strong class='mr-auto'>3º Nivel</strong>
                                        <small class='text-muted'>$dw3_id</small>
                                        <button type='button' class='ml-2 mb-1 close' data-dismiss='toast' aria-label='Close'>
                                          <span aria-hidden='true'>&times;</span>
                                        </button>
                                      </div>
                                      <div class='toast-body'>
                                        <span class='label label-success'> $dw3_user </span>
                                      </div>
                                    </div>
...
?>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <!-- Card -->
                                <h4 class='card-title'>4º Geração</h4>
							<?php
// busca usuario 
if($numrows4 > 0){
	$query4="SELECT * FROM uplines where up4 ='$my_username'ORDER BY id DESC";
	
	$result4 = mysqli_query($con,$query4);
	while($row4 = mysqli_fetch_array($result4)){
		
		$dw4_user="$row4[user_id]";
		$dw4_id="$row4[id]";
			...
			print "
					...
					<div class='card-body'>
                                ...
                                <div class='bg-light p-1'>
                                    <div class='toast' role='alert' data-autohide='false' aria-live='assertive' aria-atomic='true'>
                                      <div class='toast-header'>
                                        <svg class='bd-placeholder-img rounded mr-2' width='20' height='20' xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMidYMid slice' focusable='false' role='img'><rect fill='#ffbc34' width='100%' height='100%'></rect></svg>
                                        <strong class='mr-auto'>4º Nivel</strong>
                                        <small class='text-muted'>$dw4_id</small>
                                        <button type='button' class='ml-2 mb-1 close' data-dismiss='toast' aria-label='Close'>
                                          <span aria-hidden='true'>&times;</span>
                                        </button>
                                      </div>
                                      <div class='toast-body'>
                                        <span class='label label-warning'>$dw4_user</span>
                                      </div>
                                    </div>
...
?>
                          ...
                          <div class="col-lg-3 col-md-6">
                                <!-- Card -->
                                <h4 class='card-title'>5º Geração</h4>
							<?php
// busca usuario 
if($numrows5 > 0){
	$query5="SELECT * FROM uplines where up5 ='$my_username'ORDER BY id DESC";
	
	$result5 = mysqli_query($con,$query5);
	while($row5 = mysqli_fetch_array($result5)){
		
		$dw5_user="$row5[user_id]";
		$dw5_id="$row5[id]";
			...
			print "
					...
					<div class='card-body'>
                                ...
                                <div class='bg-light p-1'>
                                    <div class='toast' role='alert' data-autohide='false' aria-live='assertive' aria-atomic='true'>
                                      <div class='toast-header'>
                                        <svg class='bd-placeholder-img rounded mr-2' width='20' height='20' xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMidYMid slice' focusable='false' role='img'><rect fill='#7460ee' width='100%' height='100%'></rect></svg>
                                        <strong class='mr-auto'>5º Nivel</strong>
                                        <small class='text-muted'>$dw5_id</small>
                                        <button type='button' class='ml-2 mb-1 close' data-dismiss='toast' aria-label='Close'>
                                          <span aria-hidden='true'>&times;</span>
                                        </button>
                                      </div>
                                      <div class='toast-body'>
                                        <span class='label label-primary'>$dw5_user</span>
                                      </div>
                                    </div>
...
?>
       ...
       Minhas Gerações <a href="#">R&M Luxury</a>.
</footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
