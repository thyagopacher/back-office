                            ...
                            <div class="dropdown-menu animated bounceInDown">
                                <div class="mega-dropdown-menu row">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container p-0"> <img class="d-block img-fluid" src="assets/images/big/img1.jfif" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container p-0"><img class="d-block img-fluid" src="assets/images/big/img2.jfif" alt="Second slide"><img src="assets/images/users/5.jpg" alt="image" class="img-circle" width="290"></div>
                                                </div>
                                                <div class="carousel-item">
                                    ...
                                    <div class="col-lg-3 mb-4">
                                        <h4 class="mb-3">Link de Indicação</h4>
                                        <!-- Accordian -->
                                        <div id="accordion">
                                            <div class="card mb-1">
                                                ...
                                                <div id="collapseOne" data-toggle="tooltip" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
													<div class="alert alert-success">
    <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button>
    <h3 class="text-success"><i class="fa fa-check-circle"></i> Link</h3> https://rmluxury.com.br/rm/backoffice/register.php?ref=useruser02
</div>
                                    ...
                                    <div class="col-lg-3 col-xlg-4 mb-4">
                                        ...
                                        <ul class="list-style-none">
                                            <li><a href="javascript:void(1)"><i class="fa fa-check text-success"></i> You can give link</a></li>
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right  animated bounceInDown" aria-labelledby="navbarDropdown2">
								<a class="dropdown-item" href="#"><i class="flag-icon flag-icon-br"></i> Português</a>
                                ...
                                <a class="dropdown-item" href="#"><i class="flag-icon flag-icon-es"></i> Espanhol</a>
                                <a class="dropdown-item" href="#"><i class="flag-icon flag-icon-de"></i> Alemão</a>
                            </div>
                        </li>
                        <!-- ============================================================== -->
                        <!-- Comment -->
                    ...
                    <div class="col-7 align-self-center">
                        <div class="d-flex no-block justify-content-end align-items-center">
                            ...
                            <div class=""><small>Inv ON-Line</small>
                                <h4 class="text-info mb-0 font-medium">49358 </h4></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <!-- column -->
                                    <div class="col-lg-4">
                                      <h1 class="mb-0 mt-4">R$ 6,890.68</h1>
                                      ...
                                      <pre class="language-html scrollable">
                                            <code>
                                                <a href="https://rmluxury.com.br/backoffice/register.php?ref=useruser02">https://rmluxury.com.br/backoffice/register.php?ref=useruser02</a>
                                            </code>
                                        </pre>
                                    </div>
                                ...
                                <div class="row mb-0">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Valor Investido</span>
                                              <h3 class="font-medium mb-0">R$1.199,00</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- col -->
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Ganhos Indicação</span>
                                              <h3 class="font-medium mb-0">R$2.350,00</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- col -->
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Saques Realizados</span>
                                              <h3 class="font-medium mb-0">R$23,568.90</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- col -->
                ...
                <div class="row">
                    <div class="col-lg-7 col-xl-6">
                        ...
                        <div class="card card-hover">
                            <div class="card-body">
                                <h4 class="card-title">Seus Investidores pelo Mundo</h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="popover-icon">
                                                        <a class="btn-circle btn btn-info" href="javascript:void(0)">1º NIvel</a>
