...
$new_youtube=mysqli_real_escape_string($con,$_POST['youtube']);
$new_instagram=mysqli_real_escape_string($con,$_POST['instagram']);
$new_site=mysqli_real_escape_string($con,$_POST['site']);
...
if ( $new_facebook=="" ){
$msg=$msg."Faltou Colocar o Link do seu facebook.<BR>";
$status= "NOTOK";}
if ( $new_youtube=="" ){
$msg=$msg."FFaltou Colocar o Link do seu canal Youtube.<BR>";
$status= "NOTOK";}
if ( $new_instagram=="" ){
$msg=$msg."Faltou Colocar o Link do seu Instagram.<BR>";
$status= "NOTOK";}
if ( $new_site=="" ){
$msg=$msg."Faltou Colocar o Link do seu Site se Não tiver coloque um #<BR>";
$status= "NOTOK";}
...
$query=mysqli_query($con,"update affiliateuser set facebook='$new_facebook',youtube='$new_youtube',instagram='$new_instagram',site='$new_site' where username='".$_SESSION['username']."'");


$errormsg= "
<div class='alert alert-success'>
                    <button type='button' class='close' data-dismiss='alert'>&times;</button>
                    <i class='fa fa-ban-circle'></i><strong>Seus dados das Midias Sociais foram atualizados com Sucesso! </br></strong>Dados Atualizados.
					</br>
		<a href='perfil.php' class='btn btn-success'>Voltar para Tela de Edição do meu Perfil</a></div>"; //printing error if found in validation
...
<div class='alert alert-danger'>
                    <button type='button' class='close' data-dismiss='alert'>&times;</button>
                    <i class='fa fa-ban-circle'></i><strong>Atenção você precisa Corrigir os erros abaixo : </br></strong>'.$msg.'
					</br>
