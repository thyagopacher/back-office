...
<head>
    ...
    <title>Central Login - Backoffice RM Luxury - Criptogravado</title>
    <!-- Custom CSS -->
...
<body>
    ...
    <div class="progress-bar active progress-bar-striped bg-danger" style="width: 100%; height:12px;" role="progressbar"> <span class="sr-only">100% Complete</span> </div>
</div>
                                    </div>
                                </div>
                            </form>
