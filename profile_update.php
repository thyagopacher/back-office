...
<i class='fa fa-ban-circle'></i><strong>Sucesso! </br></strong>Dados de acesso Atualizados.</br>
<a href='perfil.php' class='btn btn-info'>VOLTAR PARA MEU PERFIL</a></div>"; //printing error if found in validation
...
<div class='alert alert-danger'>
		...
		<a href='perfil.php' class='btn btn-danger'>VOLTAR E CORRIGIR</a></div>"; //printing error if found in validation
                        ...
                        <div class="card">
                            ...
                            <div class="card-body"> <small class="text-muted">Seu E-mail </small>
                                ...
                                <h6><?php echo $my_endereco;?></h6>
                                 <small class="text-muted pt-4 db">Dados de Acesso</small>
                                <br/>
