...
<head>
    ...
    <title>Meus Pacotes R&M Luxury - Central Financeira</title>
    <!-- chartist CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="card bg-dark mt-0 mb-0">
                ...
                <div class="card-img-overlay">
                    ...
                    <h5 class="card-subtitle text-white op-5">Central Financeira Pacotes</h5>
                    <div class="row mt-4 mb-3">
                        <!-- col -->
                        <div class="col-sm-12 col-lg-4">
                            <div class="temp d-flex align-items-center flex-row">
                                <div class="display-5 text-white"><i class="mdi mdi-bank"></i> <span>Investimentos<sup></sup></span></div>
                                <div class="ml-2">
...
while($row = mysqli_fetch_array($result))
{
	...
	$exibir="Pendente/Inativo <a href='https://rmluxury.com.br/minha-conta/orders/' class='btn btn-sm btn-warning warning_33'>PAGAR</a>";
...
$query="SELECT * FROM  payorders where user='$my_username' AND status=1 ORDER BY id DESC";
$result = mysqli_query($con,$query);
$i=0;
while($row = mysqli_fetch_array($result))
{
